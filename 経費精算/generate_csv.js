...
function csvExport(records) {
  ...
  for (var i = 0; i < records.length; i++) {
    ...
    csv += name + ',' + expense + ',' + date + ',' + Contents + ',' + amount + ',' + Tax + ',' + _payment_due_date + '\n';
  }
  downloadFile(csv);
}
